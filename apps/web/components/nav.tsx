      ...
      <div className="mx-auto max-w-150">
        <div className="flex items-center justify-between rounded-full border border-bg/70 bg-bg/72 px-3 py-2 shadow-[0_10px_30px_rgba(44,40,37,0.08),inset_0_1px_0_rgba(246,244,241,0.7)] backdrop-blur-2xl">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-[10px] border-[0.608px] border-[rgba(92,92,92,0.45)] bg-[linear-gradient(180deg,rgba(217,217,217,0.25)_0%,#A7A7A7_53.5%,#D9D9D9_100%)] p-[1px] shadow-[0_19.44px_19.44px_-19.44px_rgba(0,0,0,0.05),0_4.86px_4.86px_-4.86px_rgba(0,0,0,0.1),0_9.72px_9.72px_-9.72px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.7),inset_0_-1px_0_rgba(0,0,0,0.15)]">
              <div className="flex h-full w-full items-center justify-center rounded-[9px] bg-[linear-gradient(180deg,rgba(217,217,217,0.25)_0%,#A7A7A7_53.5%,#D9D9D9_100%)]">
