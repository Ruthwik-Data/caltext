...
function IPhoneMock(param) {
    let { children, className, style, scale = 0.72 } = param;
...
_c = IPhoneMock;
var _c;
__turbopack_context__.k.register(_c, "IPhoneMock");
...
function PhoneMockup(param) {
    let { className = "" } = param;
    _s();
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$2d$intl$40$4$2e$9$2e$0$2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslations"])("PhoneMockup");
    ...
    const timeStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$15$2e$5$2e$14$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PhoneMockup.useMemo[timeStr]": ()=>formatDemoTime(locale)
    }["PhoneMockup.useMemo[timeStr]"], [
        locale
    ]);
    const dateStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$15$2e$5$2e$14$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PhoneMockup.useMemo[dateStr]": ()=>formatDemoDate(locale)
    }["PhoneMockup.useMemo[dateStr]"], [
        locale
    ]);
        ...
        "PhoneMockup.useEffect": ()=>{
            ...
            function runCycle() {
                ...
                transitionTimer = setTimeout({
                    "PhoneMockup.useEffect.runCycle": ()=>{
                        if (cancelled) return;
                        setPhase("chat");
                        [
                            1,
                            ...
                            "PhoneMockup.useEffect.runCycle": (count, index)=>{
                                const timer = setTimeout({
                                    "PhoneMockup.useEffect.runCycle.timer": ()=>{
                                        if (!cancelled) {
                                            setVisibleMessages(count);
                                        }
                                    }
                                }["PhoneMockup.useEffect.runCycle.timer"], 350 + index * 700);
                                messageTimers.push(timer);
                            }
                        }["PhoneMockup.useEffect.runCycle"]);
                    }
                }["PhoneMockup.useEffect.runCycle"], LOCK_SCREEN_MS);
                ...
                }["PhoneMockup.useEffect.runCycle"], LOCK_SCREEN_MS + CHAT_LOOP_MS);
            }
            runCycle();
            return ({
                "PhoneMockup.useEffect": ()=>{
...
_s(PhoneMockup, "f2PUb7LalRSYs9sNobcxaUs9zqQ=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_components_5b54a1bb._.js.map